...
export default function FlashcardPage() {
  ...
  const fetchNotes = useCallback(async () => {
    try {
      ...
      const url = limit
        ? `${process.env.MONGODB_URI}/api/public/notes?limit=${limit}`
        : `${process.env.MONGODB_URI}/api/public/notes`;
  ...
  const generateFlashcards = async () => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.MONGODB_URI}/api/flashcards/note/${selectedNote._id}/content`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
      ...
      const flashcardsResponse = await fetch(`${process.env.MONGODB_URI}/api/flashcards/generate`, {
        method: "POST",
        headers: {
  ...
  const askQuestion = async () => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.MONGODB_URI}/api/flashcards/ask`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
